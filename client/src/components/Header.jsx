...
const Profile = ({ email, name, image }) => {
    return (
        <div className="absolute top-16 right-3 z-50 bg-[#12122a] border border-[rgba(220,50,120,0.25)] rounded-2xl p-5 flex flex-col items-center gap-3 shadow-2xl min-w-[220px] text-white">
